                           ...
                           class="group flex-shrink-0 text-center min-w-[140px]">
                            ...
                            <div class="relative mb-4">
                                <div class="w-20 h-20 md:w-24 md:h-24 mx-auto relative">
                                    <?php if($category->custom_image ?? $category->image): ?>
                                        <?php
                                        ...
                                        <img src="<?php echo e($imageUrl); ?>" 
                                             alt="<?php echo e($category->custom_title ?? $category->name); ?>"
                            ...
                            <h3 class="text-sm md:text-base font-semibold text-gray-900 group-hover:text-primary transition-colors leading-tight">
                                <?php echo e($category->custom_title ?? $category->name); ?>

                            </h3>
                            
                            <!-- Product Count -->
                            <p class="text-xs text-gray-500 mt-1">
                                <?php echo e($category->products()->count()); ?> produtos
                            </p>
                        </a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\resources\views/components/category-slider.blade.php ENDPATH**/ ?>