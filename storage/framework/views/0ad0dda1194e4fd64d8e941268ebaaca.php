...
<?php $__env->startSection('title', 'Página não encontrada - 404 | ' . config('app.name')); ?>

<?php $__env->startSection('meta_description', 'A página que você está procurando não foi encontrada. Volte para a página inicial ou navegue pelo nosso catálogo de produtos.'); ?>
    ...
    <div class="max-w-2xl w-full text-center">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-200">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="<?php echo e(route('store.products')); ?>" class="text-gray-600 hover:text-primary transition-colors">
                    <i class="bi bi-box-seam block text-2xl mb-2"></i>
                    <span class="text-sm">Produtos</span>
                </a>
                <a href="<?php echo e(route('blog.index')); ?>" class="text-gray-600 hover:text-primary transition-colors">
                    <i class="bi bi-newspaper block text-2xl mb-2"></i>
                    <span class="text-sm">Blog</span>
                </a>
                <a href="<?php echo e(route('contact.index')); ?>" class="text-gray-600 hover:text-primary transition-colors">
                    <i class="bi bi-envelope block text-2xl mb-2"></i>
                    <span class="text-sm">Contato</span>
                </a>
                <a href="<?php echo e(route('page.show', 'sobre-nos')); ?>" class="text-gray-600 hover:text-primary transition-colors">
        ...
        <div class="mt-8">
            ...
            <form action="<?php echo e(route('store.products')); ?>" method="GET" class="max-w-md mx-auto">
