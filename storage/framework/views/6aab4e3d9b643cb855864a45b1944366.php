<?php $__env->startSection('title', 'Novo Produto - Laser Link'); ?>
<?php $__env->startSection('page-title', 'Novo Produto'); ?>
...
<div class="space-y-6" x-data="productManager()">
    <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" enctype="multipart/form-data" id="productForm" onsubmit="return validateProductForm(event)">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" 
                              name="description" 
                              rows="10"
                              class="quill-editor"><?php echo e(old('description')); ?></textarea>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               id="price" 
                               name="price" 
                               value="<?php echo e(old('price') ? number_format((float)old('price'), 2, ',', '.') : ''); ?>"
                               placeholder="0,00"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               id="sale_price" 
                               name="sale_price" 
                               value="<?php echo e(old('sale_price') ? number_format((float)old('sale_price'), 2, ',', '.') : ''); ?>"
                               placeholder="0,00"
                        ...
                        <div x-show="showSeoPreview" 
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="text-green-700 text-sm">
                                    <?php echo e(url('/')); ?>/produto/<span x-text="seoData.slug || 'nome-do-produto'"></span>
                                </div>
...
<script src="<?php echo e(asset('js/file-manager-for-create.js')); ?>"></script>
...
<?php echo $__env->make('admin.products.partials.file-manager-modals', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>


<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/admin/products/create.blade.php ENDPATH**/ ?>