        ...
        <div class="flex items-center p-4 gap-4">
            ...
            <div class="flex-shrink-0">
                <div class="w-16 h-16 from-primary to-red-700 rounded-xl flex items-center justify-center shadow-lg">
                    <img src="<?php echo e(url('images/icon-144x144.png')); ?>" alt="Laser Link" class="w-full h-full">
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\resources\views/components/pwa-install-banner.blade.php ENDPATH**/ ?>