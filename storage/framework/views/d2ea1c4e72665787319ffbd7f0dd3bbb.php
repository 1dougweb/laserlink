    ...
    <nav class="flex mb-6 text-sm" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="<?php echo e(route('store.index')); ?>" class="text-gray-600 hover:text-gray-900">
    ...
    <div class="flex flex-col lg:flex-row ">
        ...
        <aside class="lg:w-64 flex-shrink-0 mr-8">
            ...
            <div :class="{'hidden lg:block': !showFilters}" class="space-y-6">
                <form method="GET" action="<?php echo e(route('store.products')); ?>" id="filter-form" @submit.prevent="submitForm">
                    <!-- Categorias -->
                        ...
                        <div x-show="openCategories" x-collapse class="space-y-2">
                            ...
                            <div class="mb-3 pb-3 border-b border-gray-200">
                                <a href="<?php echo e(route('store.products')); ?>" 
                                   class="flex items-center cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors <?php echo e(!request('categoria') ? 'bg-red-50' : ''); ?>">
                                    <i class="bi bi-grid-3x3-gap text-red-600 mr-2"></i>
                                    <span class="text-sm font-semibold <?php echo e(!request('categoria') ? 'text-red-600' : 'text-gray-900'); ?>">
                                        Todas as Categorias
                                    </span>
                                </a>
                            </div>
                            ...
                            <div class="space-y-1" x-data="{ 
                                openSubcategory_<?php echo e($parentCategory->id); ?>: <?php echo e($shouldBeOpen ? 'true' : 'false'); ?>

                            }">
                                <div class="flex items-center justify-between">
                                    <label class="flex items-center cursor-pointer flex-1" @click="openSubcategory_<?php echo e($parentCategory->id); ?> = true">
                                        <input type="checkbox" 
                                               name="categoria[]" 
                                               value="<?php echo e($parentCategory->slug); ?>" 
                                               <?php echo e(is_array(request('categoria')) && in_array($parentCategory->slug, request('categoria')) ? 'checked' : ''); ?>

                                               <?php echo e(!is_array(request('categoria')) && request('categoria') === $parentCategory->slug ? 'checked' : ''); ?>

                                               class="text-red-600 focus:ring-red-500 rounded"
                                               @change="applyFilters()">
                                        <span class="ml-2 text-sm font-medium text-gray-900"><?php echo e($parentCategory->name); ?></span>
                                    </label>
                                    
                                    <?php if($parentCategory->activeChildren && $parentCategory->activeChildren->count() > 0): ?>
                                    <button @click="openSubcategory_<?php echo e($parentCategory->id); ?> = !openSubcategory_<?php echo e($parentCategory->id); ?>" 
                                            type="button" 
                                            class="ml-2 p-1 hover:bg-gray-100 rounded transition-colors">
                                        <i class="bi transition-transform text-red-600" 
                                           :class="openSubcategory_<?php echo e($parentCategory->id); ?> ? 'bi-chevron-up' : 'bi-chevron-down'"></i>
                                    </button>
                                    <?php endif; ?>
                                </div>
                                ...
                                <!-- Subcategorias -->
                                <?php if($parentCategory->activeChildren && $parentCategory->activeChildren->count() > 0): ?>
                                <div x-show="openSubcategory_<?php echo e($parentCategory->id); ?>" x-collapse class="ml-6 space-y-1 mt-1">
                                    <?php $__currentLoopData = $parentCategory->activeChildren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center cursor-pointer hover:bg-gray-50 p-1 rounded transition-colors">
                                        <input type="checkbox" 
                                               ...
                                               <?php echo e(is_array(request('categoria')) && in_array($subCategory->slug, request('categoria')) ? 'checked' : ''); ?>

                                               <?php echo e(!is_array(request('categoria')) && request('categoria') === $subCategory->slug ? 'checked' : ''); ?>

                                               class="text-red-600 focus:ring-red-500 rounded"
                                               @change="applyFilters()">
                                        <span class="ml-2 text-sm text-gray-700"><?php echo e($subCategory->name); ?></span>
                                    </label>
                        ...
                        <div x-show="openPrice" x-collapse class="space-y-3">
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01"
                                       placeholder="R$ <?php echo e(number_format($minPrice, 2, ',', '.')); ?>"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       max="<?php echo e($maxPrice); ?>"
                                       step="0.01"
                                       placeholder="R$ <?php echo e(number_format($maxPrice, 2, ',', '.')); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 text-sm">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4 space-y-2">
                        ...
                        <?php if(request()->hasAny(['busca', 'categoria', 'preco_min', 'preco_max', 'tipo', 'ordenar'])): ?>
                        <a href="<?php echo e(route('store.products')); ?>" 
                        ...
                        <div x-show="openType" x-collapse class="space-y-2">
                            <label class="flex items-center cursor-pointer hover:bg-gray-50 p-2 rounded">
                                <input type="radio" 
                                       name="tipo" 
                                       value="" 
                                       <?php echo e(!request('tipo') ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center cursor-pointer hover:bg-gray-50 p-2 rounded">
                                <input type="radio" 
                                       name="tipo" 
                                       value="novos" 
                                       <?php echo e(request('tipo') === 'novos' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center cursor-pointer hover:bg-gray-50 p-2 rounded">
                                <input type="radio" 
                                       name="tipo" 
                                       value="promocoes" 
                                       <?php echo e(request('tipo') === 'promocoes' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center cursor-pointer hover:bg-gray-50 p-2 rounded">
                                <input type="radio" 
                                       name="tipo" 
                                       value="destaques" 
                                       <?php echo e(request('tipo') === 'destaques' ? 'checked' : ''); ?>
        ...
        <div class="flex-1">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        <?php echo e($products->total()); ?> <?php echo e($products->total() === 1 ? 'produto encontrado' : 'produtos encontrados'); ?>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <form method="GET" action="<?php echo e(route('store.products')); ?>" class="inline-block">
                        <?php $__currentLoopData = request()->except('ordenar'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <select name="ordenar" 
                            ...
                            <option value="menor_preco" <?php echo e(request('ordenar') === 'menor_preco' ? 'selected' : ''); ?>>Menor preço</option>
                            <option value="maior_preco" <?php echo e(request('ordenar') === 'maior_preco' ? 'selected' : ''); ?>>Maior preço</option>
                            <option value="nome_az" <?php echo e(request('ordenar') === 'nome_az' ? 'selected' : ''); ?>>Nome (A-Z)</option>
                            <option value="nome_za" <?php echo e(request('ordenar') === 'nome_za' ? 'selected' : ''); ?>>Nome (Z-A)</option>
                        </select>
                    </form>
                </div>
            </div>
            ...
            <!-- Active Filters -->
            <?php if(request()->hasAny(['busca', 'categoria', 'preco_min', 'preco_max', 'tipo'])): ?>
            <div class="mb-6 flex flex-wrap gap-2">
                <span class="text-sm text-gray-600">Filtros ativos:</span>
                
                <?php if(request('busca')): ?>
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-red-100 text-red-800">
                    Busca: "<?php echo e(request('busca')); ?>"
                    <a href="<?php echo e(request()->fullUrlWithQuery(['busca' => null])); ?>" class="ml-2 hover:text-red-900">
                        <i class="bi bi-x"></i>
                    </a>
                </span>
                <?php endif; ?>
                ...
                <?php if(request('categoria')): ?>
                    <?php
                        $selectedCategories = is_array(request('categoria')) ? request('categoria') : [request('categoria')];
                    ?>
                    <?php $__currentLoopData = $selectedCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorySlug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-blue-100 text-blue-800">
                            ...
                            <a href="<?php echo e(request()->fullUrlWithQuery(['categoria' => count($remainingCategories) > 0 ? array_values($remainingCategories) : null])); ?>" class="ml-2 hover:text-blue-900">
                                <i class="bi bi-x"></i>
                            </a>
                        </span>
                        <?php endif; ?>
                ...
                <?php if(request('preco_min') || request('preco_max')): ?>
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-green-100 text-green-800">
                    Preço: R$ <?php echo e(number_format(request('preco_min', $minPrice), 2, ',', '.')); ?> - R$ <?php echo e(number_format(request('preco_max', $maxPrice), 2, ',', '.')); ?>

                    <a href="<?php echo e(request()->fullUrlWithQuery(['preco_min' => null, 'preco_max' => null])); ?>" class="ml-2 hover:text-green-900">
                        <i class="bi bi-x"></i>
                    </a>
                </span>
                <?php endif; ?>
                ...
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-purple-100 text-purple-800">
                    <?php echo e(ucfirst(request('tipo'))); ?>

                    <a href="<?php echo e(request()->fullUrlWithQuery(['tipo' => null])); ?>" class="ml-2 hover:text-purple-900">
                        <i class="bi bi-x"></i>
                    </a>
                </span>
                <?php endif; ?>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('productsPage', () => ({
        ...
        filterTimeout: null,
        loading: false,
        searchQuery: '<?php echo e(request("busca") ?? ""); ?>',
        ...
        submitForm() {
            ...
            const url = '<?php echo e(route("store.products")); ?>' + (params.toString() ? '?' + params.toString() : '');
...
<?php echo $__env->make('layouts.store', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/store/products.blade.php ENDPATH**/ ?>