<?php $__env->startSection('title', 'Loja Virtual - LaserLink'); ?>
...
<div x-data="{ mobileMenuOpen: false }">
                ...
                <div class="relative overflow-hidden rounded-2xl shadow-xl h-96"
                    ...
                    <?php $__currentLoopData = $homeBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div x-show="currentSlide === <?php echo e($index); ?>" 
                            ...
                            <img src="<?php echo e($bannerUrl); ?>" alt="Banner promocional Laser Link - Comunicação Visual <?php echo e($index + 1); ?>" class="w-full h-full object-cover rounded-2xl">
                        </div>
                    ...
                    <?php if(count($homeBanners) > 1): ?>
                        ...
                        <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex space-x-2">
                            <?php $__currentLoopData = $homeBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button @click="goToSlide(<?php echo e($index); ?>); stopAutoplay()"
                                        class="h-2 rounded-full transition-all duration-300"
                                        :class="currentSlide === <?php echo e($index); ?> ? 'bg-white w-8' : 'bg-white/50 w-2 hover:bg-white/80'">
                                </button>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
        ...
        <section class="relative z-0 md:hidden" x-data="{ 
            ...
            <div class="max-w-7xl mx-auto px-4 py-4">
                <div class="relative overflow-hidden rounded-2xl shadow-xl"
                    ...
                    <!-- Slides Mobile -->
                    <?php $__currentLoopData = $homeBannersMobile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <div x-show="currentSlideMobile === <?php echo e($index); ?>" 
                             x-transition:enter="transition ease-out duration-700"
                             x-transition:enter-start="opacity-0 scale-105"
                             x-transition:enter-end="opacity-100 scale-100"
                             x-transition:leave="transition ease-in duration-300"
                             ...
                             x-transition:leave-end="opacity-0 scale-95"
                             class="absolute inset-0 w-full h-full">
                            <img src="<?php echo e($bannerUrl); ?>" alt="Banner mobile Laser Link - Promoções e produtos de comunicação visual <?php echo e($index + 1); ?>" class="w-full h-full object-cover rounded-2xl">
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(count($homeBannersMobile) > 1): ?>
                        ...
                        <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex space-x-2">
                            <?php $__currentLoopData = $homeBannersMobile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button @click="goToSlideMobile(<?php echo e($index); ?>); stopAutoplayMobile()"
                                        class="h-2 rounded-full transition-all duration-300"
                                        :class="currentSlideMobile === <?php echo e($index); ?> ? 'bg-white w-8' : 'bg-white/50 w-2'">
                                </button>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
    ...
    <section class="py-8" 
                ...
                Alpine.data('storeProducts', () => ({
                    ...
                    toggleFavorite(productId) {
                        ...
                        const productData = {
                            ...
                            image_url: product.featured_image || product.first_image || '<?php echo e(url('images/general/callback-image.svg')); ?>'
                        };
        ...
        <!-- Category Slider -->
        <?php if (isset($component)) { $__componentOriginal999a4ec450f8c86e2b2dd313d5743d91 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal999a4ec450f8c86e2b2dd313d5743d91 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.category-slider','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal999a4ec450f8c86e2b2dd313d5743d91)): ?>
<?php $attributes = $__attributesOriginal999a4ec450f8c86e2b2dd313d5743d91; ?>
<?php unset($__attributesOriginal999a4ec450f8c86e2b2dd313d5743d91); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal999a4ec450f8c86e2b2dd313d5743d91)): ?>
<?php $component = $__componentOriginal999a4ec450f8c86e2b2dd313d5743d91; ?>
<?php unset($__componentOriginal999a4ec450f8c86e2b2dd313d5743d91); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.loading-spinner','data' => ['size' => 'lg','text' => 'Carregando produtos...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'lg','text' => 'Carregando produtos...']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.store', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/store/index.blade.php ENDPATH**/ ?>