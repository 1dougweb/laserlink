    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div class="col-span-1 md:col-span-2 lg:col-span-2">
                <?php if($footerLogoUrl): ?>
                    <!-- Logo do Rodapé -->
                    <div class="mb-4">
                        <img src="<?php echo e($footerLogoUrl); ?>" 
                ...
                <p class="text-gray-300 mb-4 max-w-md"><?php echo e($siteDescription); ?></p>
                    ...
                    <div class="space-y-2">
                        <?php if($sitePhone): ?>
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-gray-300"><?php echo e($sitePhone); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($siteEmail): ?>
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="mailto:<?php echo e($siteEmail); ?>" class="text-gray-300 hover:text-white"><?php echo e($siteEmail); ?></a>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($siteAddress): ?>
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-gray-300"><?php echo e($siteAddress); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if(count($socialMedia) > 0): ?>
                    <div class="mt-6">
                        ...
                        <div class="flex items-center gap-3">
                            <?php $__currentLoopData = $socialMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($social['url']); ?>" 
                                   target="_blank"
                                   rel="noopener noreferrer"
                                   class="flex items-center justify-center w-10 h-10 bg-gray-800 rounded-full text-white transition-all duration-300 <?php echo e($social['color']); ?> hover:scale-110 hover:shadow-lg"
                                   title="<?php echo e(ucfirst($name)); ?>">
                                    <i class="bi <?php echo e($social['icon']); ?> text-lg"></i>
                                </a>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <li>
                            <a href="<?php echo e(route('store.user-orders')); ?>" 
                               class="text-gray-300 hover:text-white transition-colors flex items-center">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('store.category', $category->slug)); ?>" 
                               class="text-gray-300 hover:text-white transition-colors flex items-center">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="<?php echo e(route('page.show', 'sobre-nos')); ?>" 
                           class="text-gray-300 hover:text-white transition-colors flex items-center">
                    ...
                    <li>
                        <a href="<?php echo e(route('page.show', 'termos-de-uso')); ?>" 
                           class="text-gray-300 hover:text-white transition-colors flex items-center">
                    ...
                    <li>
                        <a href="<?php echo e(route('page.show', 'politica-de-troca-e-devolucao')); ?>" 
                           class="text-gray-300 hover:text-white transition-colors flex items-center">
                    ...
                    <li>
                        <a href="<?php echo e(route('page.show', 'politica-de-entrega')); ?>" 
                           class="text-gray-300 hover:text-white transition-colors flex items-center">
                    ...
                    <li>
                        <a href="<?php echo e(route('page.show', 'perguntas-frequentes')); ?>" 
                           class="text-gray-300 hover:text-white transition-colors flex items-center">
        ...
        <?php if($whatsappNumber): ?>
            <div class="fixed bottom-6 md:bottom-6 right-6 z-50 transition-all duration-300" style="bottom: calc(4rem + 64px);">
                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $whatsappNumber)); ?>" 
                   target="_blank"
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center">
            <p class="text-gray-400">
                © <?php echo e(date('Y')); ?> <?php echo e($siteName); ?>. Todos os direitos reservados.
            </p>
            
            <?php if($footerExtraText): ?>
                <div class="mt-4 text-gray-300 text-sm leading-relaxed">
                    <?php echo nl2br(e($footerExtraText)); ?>
...
</footer><?php /**PATH C:\xampp\htdocs\resources\views/components/store-footer.blade.php ENDPATH**/ ?>