...
return new class extends Migration
{
    ...
    {
        // Tabela principal de campos (verificar se já existe)
        ...
        // Tabela de opções dos campos (verificar se já existe)
        ...
        // Tabela de associação produto-campo (verificar se já existe)
        if (!Schema::hasTable('product_extra_fields')) {
        ...
        // Tabela de seções (para agrupar campos) (verificar se já existe)
        if (!Schema::hasTable('extra_sections')) {
        ...
        // Tabela de associação produto-seção (verificar se já existe)
        if (!Schema::hasTable('product_extra_sections')) {
