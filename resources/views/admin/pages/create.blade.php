...
@section('title', 'Nova Página - Laser Link')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary">{{ old('meta_description') }}</textarea>
