...
@section('page-title', 'Histórico de Movimentações')
...
<div class="space-y-6">
    ...
    <!-- Filtros de Pesquisa -->
    <div class="bg-white rounded-lg shadow" x-data="{ showFilters: {{ request()->hasAny(['product_id', 'type', 'start_date', 'end_date']) ? 'true' : 'false' }} }">
        ...
        <form method="GET" action="{{ route('admin.stock.movements') }}" x-show="showFilters" x-cloak>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Movimentações de Estoque</h3>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                {{ $movement->unit_cost ? 'R$ ' . number_format($movement->unit_cost, 2, ',', '.') : '-' }}
                            </td>
