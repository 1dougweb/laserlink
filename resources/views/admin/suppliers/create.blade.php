        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="company_name" id="company_name" x-model="company_name" value="{{ old('company_name') }}"
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="mb-6">
                ...
                <textarea name="address" id="address" x-model="address" rows="2"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                @error('address')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="city" id="city" x-model="city" value="{{ old('city') }}"
                ...
                <div>
                    ...
                    <input type="text" name="state" id="state" x-model="state" value="{{ old('state') }}" maxlength="2"
            ...
            async fetchCNPJData() {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        this.name = data.nome_fantasia || data.razao_social || '';
                        this.email = data.email || '';
                        this.phone = data.ddd_telefone_1 ? this.formatPhoneFromAPI(data.ddd_telefone_1) : '';
                        this.zip_code = data.cep ? data.cep.replace(/\D/g, '').replace(/^(\d{5})(\d)/, '$1-$2') : '';
                        this.address = this.buildAddress(data);
